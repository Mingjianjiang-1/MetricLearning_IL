...
def train_bc_actor(
    ...
    for i in range(total_steps // batch_size_bc):
        ...
        if i % 500 == 0:
            print(float(np.array(test_policy(bc_actor, eval_env, episodes=10)).mean()), flush=True)
    ...
    print(f"Average return {average_return}", flush=True)
